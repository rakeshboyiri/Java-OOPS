...
t3=new TextField();
t3.setBounds(140,230,100,20); CheckboxGroup cbg=new
CheckboxGroup(); Checkbox box1=new
Checkbox("012",false,cbg); Checkbox box2=new
Checkbox("310",false,cbg); Checkbox box3=new
Checkbox("311",false,cbg); box1.setBounds(140,140,40,20);


box2.setBounds(200,140,40,20);
box3.setBounds(240,140,40,20); CheckboxGroup cbg1=new
CheckboxGroup(); Checkbox box4=new
Checkbox("Male",false,cbg1); Checkbox box5=new
Checkbox("Female",false,cbg1);
box4.setBounds(140,170,60,20);
box5.setBounds(200,170,60,20); Button b=new
Button("Submit");
