...
class Three_weller extends Vehicle{
	//Child class inherited properties from Vehicle Parent class
	Three_weller(String vehicle_NO,String vehicle_Model,String vehicle_Color,String vehicle_FuelType,int vehicle_mileage){
		//Initilization of values by constructor
		System.out.println("Three weeler Vehicle ");
	...
	public static void main(String [] args){
		...
		Three_weller three = new Three_weller(vehicle_no,vehicle_model,vehicle_color,fuel_type,mileage);
		three.display();
